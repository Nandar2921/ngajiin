  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0b1120', color: '#f1f5f9', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <section style={{ maxWidth: '820px', margin: '0 auto', padding: '0 32px 64px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: '#22d3a0', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{t('home.howItWorks')}</div>
        <div style={{ fontSize: '24px', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em', marginBottom: '6px' }}>{t('home.howItWorksTitle')}</div>
        <div style={{ fontSize: '14px', color: '#334155', marginBottom: '28px' }}>{t('home.howItWorksDesc')}</div>
      ...
      {/* TOPICS */}
      <section style={{ maxWidth: '820px', margin: '0 auto', padding: '0 32px 64px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: '#22d3a0', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{t('home.popular')}</div>
        <div style={{ fontSize: '24px', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em', marginBottom: '6px' }}>{t('home.popularTitle')}</div>
        <div style={{ fontSize: '14px', color: '#334155', marginBottom: '20px' }}>{t('home.popularDesc')}</div>
      ...
      {/* FEATURES */}
      <section style={{ maxWidth: '820px', margin: '0 auto', padding: '0 32px 64px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: '#22d3a0', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{t('home.features')}</div>
        <div style={{ fontSize: '24px', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em', marginBottom: '6px' }}>{t('home.featuresTitle')}</div>
        <div style={{ fontSize: '14px', color: '#334155', marginBottom: '20px' }}>{t('home.featuresDesc')}</div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(185px, 1fr))', gap: '10px' }}>
          {[
            { icon: '📖', name: "Al-Qur'an", desc: t('home.quranDesc'), color: '#22d3a0', bg: 'rgba(34,211,160,0.1)', href: '/surah' },
            { icon: '📜', name: 'Hadits', desc: t('home.hadithDesc'), color: '#60a5fa', bg: 'rgba(96,165,250,0.1)', href: '/hadith' },
            { icon: '📚', name: 'Tafsir', desc: t('home.tafsirDesc'), color: '#c084fc', bg: 'rgba(192,132,252,0.1)', href: '/tafsir' },
            { icon: '🤲', name: 'Doa Harian', desc: t('home.doaDesc'), color: '#fbbf24', bg: 'rgba(251,191,36,0.1)', href: '/doa' },
          ].map((f, i) => (
            <Link key={i} href={f.href} style={{ textDecoration: 'none' }}>
              ...
              >
                ...
                <div style={{ fontSize: '12px', fontWeight: 600, color: f.color }}>{t('common.viewAll')} →</div>
              </div>
            </Link>
          ))}
        </div>
      ...
      {/* AYAT OF THE DAY */}
      <section style={{ maxWidth: '820px', margin: '0 auto', padding: '0 32px 64px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: '#22d3a0', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{t('home.ayahOfDay')}</div>
        <div style={{ fontSize: '24px', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em', marginBottom: '6px' }}>{t('home.ayahOfDayTitle')}</div>
        <div style={{ fontSize: '14px', color: '#334155', marginBottom: '20px' }}>{t('home.ayahOfDayDesc')}</div>
      ...
      {/* SURAH LIST */}
      <section style={{ maxWidth: '820px', margin: '0 auto', padding: '0 32px 64px' }}>
        <div style={{ fontSize: '11px', fontWeight: 700, color: '#22d3a0', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '10px' }}>{t('quran.title')}</div>
        <div style={{ fontSize: '24px', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.02em', marginBottom: '6px' }}>{t('quran.surahs')}</div>
            ...
            <Link key={s.n} href={`/surah/${s.n}`} style={{ textDecoration: 'none' }}>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: '11px', color: '#334155', marginTop: '2px' }}>{s.arti} · {s.type} · {s.ayat} {t('quran.verses')}</div>
                </div>
