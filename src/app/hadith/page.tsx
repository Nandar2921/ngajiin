      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          <select
            ...
            className="px-4 py-2.5 bg-card border border-border rounded-xl focus:outline-none focus:border-emerald-500 text-foreground min-w-[180px]"
          >
          ...
          {(search || selectedBook) && (
            <button
              onClick={handleReset}
              className="px-4 py-2.5 bg-muted hover:bg-muted/70 text-foreground rounded-xl transition"
              title="Reset filter"
            >
              <X className="w-5 h-5" />
            </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground">Tidak ada hadits ditemukan</p>
            {(search || selectedBook) && (
              <button
                onClick={handleReset}
                ...
                <div className="group block bg-card/70 border border-border/60 rounded-xl p-5 hover:bg-card hover:border-emerald-500/30 transition-all duration-200 cursor-pointer">
                  <div className="flex justify-between items-start mb-3 flex-wrap gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-muted-foreground">{hadith.book_name}</span>
                    </div>
                    {hadith.grade && (
                  ...
                  {hadith.arabic && (
                    <div className="text-right text-xl font-arabic mb-3 leading-relaxed text-foreground">
