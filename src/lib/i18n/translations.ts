...
export const translations: Record<Language, Translation> = {
  id: {
    ...
    'home.heroSubtitle': 'Ketik pertanyaan atau topik bebas — SiKAJI otomatis membaca database dan mencarikan ayat, hadits, serta tafsir yang paling relevan.',
    ...
    // Footer
    'footer.copyright': 'Hak Cipta © 2026 SiKAJI. All rights reserved.',
  ...
  en: {
    ...
    'home.heroSubtitle': 'Type your question or topic — SiKAJI automatically searches the database and finds the most relevant verses, hadiths, and tafsir.',
    ...
    // Footer
    'footer.copyright': 'Copyright © 2026 SiKAJI. All rights reserved.',
  ...
  ar: {
    ...
    'home.heroSubtitle': 'اكتب سؤالك أو موضوعك — SiKAJI يبحث تلقائياً في قاعدة البيانات ويجد الآيات والأحاديث والتفسيرات الأكثر صلة.',
    ...
    // Footer
    'footer.copyright': 'جميع الحقوق محفوظة © 2026 SiKAJI',
